...
CREATE   PROCEDURE [reporting].[I_CVS_ODE_Extract]
...
drop table if exists #CVS_ODE_Extract
...
into #CVS_ODE_Extract
from staging.CVS_ODE_Source co
left join (select * 
