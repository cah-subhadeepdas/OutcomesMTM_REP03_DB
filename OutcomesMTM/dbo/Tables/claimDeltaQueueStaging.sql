CREATE TABLE [dbo].[claimDeltaQueueStaging] (
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [claimdeltaqueuestaging_claimid_changedate_createdt]
    ON [dbo].[claimDeltaQueueStaging]([claimID] ASC, [changeDate] ASC, [createDT] ASC);
