CREATE TABLE [dbo].[EMTM_ReportingTable] (
    ...
    [CreateDt]                   DATETIME      CONSTRAINT [DF_EMTM_ReportingTable_CreateDT] DEFAULT (getdate()) NOT NULL,
    [UpdatedField]               VARCHAR (MAX) NULL,
    [ChangeDt]                   DATETIME      NULL,
    [IsCurrent]                  BIT           CONSTRAINT [DF_EMTM_ReportingTable_IsCurrent] DEFAULT ((1)) NULL,
    [HasError]                   BIT           CONSTRAINT [DF_EMTM_ReportingTable_HasError] DEFAULT ((0)) NULL,
    [ErrorCorrected]             BIT           CONSTRAINT [DF_EMTM_ReportingTable_ErrorCorrected] DEFAULT ((0)) NULL,
    [IsExported]                 BIT           NULL,
    [ExportFileName]             VARCHAR (100) NULL,
    [ExportFileDate]             DATETIME      NULL,
    CONSTRAINT [PK_EMTM_ReportingTable] PRIMARY KEY CLUSTERED ([RecordID] ASC)
);
