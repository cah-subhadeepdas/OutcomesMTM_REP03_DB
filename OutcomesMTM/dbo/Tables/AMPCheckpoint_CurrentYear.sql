CREATE TABLE [dbo].[AMPCheckpoint_CurrentYear] (
    ...
    [ReportRunDate]                         DATE           CONSTRAINT [DF_AMPCheckpointData_ReportRunDate] DEFAULT (getdate()) NULL,
    [ReportYear]                            SMALLINT       CONSTRAINT [DF_AMPCheckpoint_CurrentYear_ReportYear] DEFAULT (datepart(year,getdate())) NULL,
