CREATE TABLE [dbo].[EMTM_ReportingTable_20170410] (
    ...
    [CreateDt]                   DATETIME      CONSTRAINT [DF_EMTM_ReportingTable_20170410_CreateDT] DEFAULT (getdate()) NOT NULL,
    [UpdatedField]               VARCHAR (MAX) NULL,
    [ChangeDt]                   DATETIME      NULL,
    [IsCurrent]                  BIT           CONSTRAINT [DF_EMTM_ReportingTable_20170410_IsCurrent] DEFAULT ((1)) NULL
);
