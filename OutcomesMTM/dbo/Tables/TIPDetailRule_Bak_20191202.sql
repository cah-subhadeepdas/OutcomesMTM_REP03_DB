CREATE TABLE [dbo].[TIPDetailRule_Bak_20191202] (
    ...
    [MedSyncTool]                  BIT             NULL,
    [primaryPharmacyOnly]          BIT             NULL,
    [dispensingPharmacyOnly]       BIT             NULL,
    ...
    [labID]                        INT             NULL,
    CONSTRAINT [PK_TIPDetailRule] PRIMARY KEY CLUSTERED ([TIPDetailRuleID] ASC) WITH (FILLFACTOR = 80)
);
