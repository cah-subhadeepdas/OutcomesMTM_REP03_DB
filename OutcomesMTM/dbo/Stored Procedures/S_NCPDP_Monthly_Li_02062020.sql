...
Create  procedure [dbo].[S_NCPDP_Monthly_Li_02062020] @report_date date as 
...
LEFT JOIN GetOutcomes2007.dbo.tblPharmacy AS ph WITH(NOLOCK) ON dlp.pharmacyid=ph.PharmacyID
LEFT JOIN GetOutcomes2007.dbo.vw_MTMCenter AS mtmc WITH(NOLOCK) ON ph.PharmacyID=mtmc.PharmacyID
