...
CREATE procedure [dbo].[U_PATIENTDIM]
as 
begin
set nocount on;
set xact_abort on;
...
begin 
	...
	--TC-3221 ..Not required.. Since Patient Refactor in July-2019,  Brett/Growlers are going to send only insert = 1.
	/* 
	--patientDim
	--DELETES
	update d  
