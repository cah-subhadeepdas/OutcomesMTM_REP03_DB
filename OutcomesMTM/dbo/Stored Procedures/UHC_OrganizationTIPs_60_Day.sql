...
CREATE proc [dbo].[UHC_OrganizationTIPs_60_Day] 
...
from(
       ...
       from (
              ...
              , ta.*
			  , case when ta.tipdetailid not in (1759, 1760, 1761) and (ta.[TIP Activity] = 1 or datediff(day,ta.activeasof,ta.activethru) >= 60) then 1 else 0 end as [60dayTip]
			  ...
			  , case when (ta.tipdetailid not in (1759, 1760, 1761) and (ta.[TIP Activity] = 1 or datediff(day,ta.activeasof,ta.activethru) >= 60))
