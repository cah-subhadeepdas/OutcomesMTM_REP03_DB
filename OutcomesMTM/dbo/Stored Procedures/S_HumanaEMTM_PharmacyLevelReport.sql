...
CREATE procedure [dbo].[S_HumanaEMTM_PharmacyLevelReport]
AS 
BEGIN
...
Select DISTINCT
		...
		, ISNULL(cmr.[Completed CMR],0) + ISNULL(TipComp.[Tips Completed],0) as  [Humana EMTM Completed]
		, ISNULL(TipOpp.tipopportunities,0) + ISNULL(CMR.[CMR Opportunities],0) as [Humana EMTM Opportunities]
into #EMTM
