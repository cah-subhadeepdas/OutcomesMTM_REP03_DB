...
CREATE   proc [dbo].[UHC_OrganizationTIPs_30_Day_Sam] 
...
drop table IF EXISTS #UHCOrganizationTips
...
from (
		...
		from (
				...
				join (
					   ...
					   LEFT JOIN dbo.UHC_TipType tt on tt.TipTypeID = td.tipTypeID
					   where 1=1 
					   and td.tipdetailid in (318,319,320,393,394,395,650,1759, 1760,1761,1768,1857,1858,1859,1901,1904,1953,1954,2079,2084,2085,2089,2091,2092,2093,2094,2096)
				...
				and c.statusID = 6
				and cv.active = 1
--				AND ((c.reasontypeid = 31 and c.actiontypeid = 2 and c.resulttypeid = 44 )
--or (c.reasontypeid = 32 and c.actiontypeid = 2 and c.resulttypeid = 45 )
--or (c.reasontypeid = 31 and c.actiontypeid = 2 and c.resulttypeid = 12 )
--or (c.reasontypeid = 31 and c.actiontypeid = 2 and c.resulttypeid = 18 ))
