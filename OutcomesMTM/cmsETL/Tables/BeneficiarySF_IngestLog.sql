CREATE TABLE [cmsETL].[BeneficiarySF_IngestLog] (
    [IngestLogID]               BIGINT         IDENTITY (1, 1) NOT NULL,
    [IngestLogDT]               DATETIME       DEFAULT (getdate()) NULL,
    [FileID]                    INT            NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([IngestLogID] ASC)
);
